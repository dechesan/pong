...
function love.update(dt)
    ...
    --
    -- player 1 AI - using half speed so the AI can't always reach the ball
    if player1.y > ball.y then
        player1.dy = -PADDLE_SPEED / 2
    elseif player1.y + PADDLE_HEIGHT < ball.y + BALL_SIZE then
        player1.dy = PADDLE_SPEED / 2
    else
        player1.dy = 0
    end
...
--[[     if love.keyboard.isDown('w') then
    ...
    -- player 2 AI - using half speed so the AI can't always reach the ball
    if player2.y > ball.y then
        player2.dy = -PADDLE_SPEED / 2
    elseif player2.y + PADDLE_HEIGHT < ball.y + BALL_SIZE then
        player2.dy = PADDLE_SPEED / 2
    else
        player2.dy = 0
    end
